  ...
  try {
    ...
    try {
      ...
      const products = await Product.find(filter)
        .select('_id name price quantity uom brandName barcode productCode modelName image images category description retailDiscount retailPrice discount wholesalePrice superDiscount superWholesalePrice minRetailQuantity minWholesaleQuantity minSuperWholesaleQuantity attributes createdBy createdAt updatedAt stockThreshold mrp')
